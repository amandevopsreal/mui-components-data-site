...
const AlertDialog: React.FC<AlertDialogProps> = ({ setInvalid }) => {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-title">{"Enter the details."}</DialogTitle>
        <DialogContent>
        ...
        <Grid style={{ display: 'flex', justifyContent: 'center' }}>
          <Grid item xs={9} sm={6} md={3}>
            <Paper elevation={10} style={paperStyle}>
              ...
              <Button onClick={onSubmit} style={btnstyle} fullWidth variant="contained" color="primary" type="submit">
                Submit
              </Button>
            </Paper>
          </Grid>
